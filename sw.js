const CACHE = "life-system-v78";
const ASSETS = ["./", "./index.html", "./styles.css", "./core-overrides.css", "./app.js", "./atlas-data.js", "./skills-data.js", "./assets/world-core-glass-shell.png", "./assets/world-core-night-sky.png", "./assets/audio/celebration-event.mp3", "./assets/audio/rain-field.mp3", "./assets/audio/meal-phase.mp3", "./assets/audio/campus-day.mp3", "./assets/audio/christmas-world.mp3", "./assets/audio/morning-field-entry.mp3", "./assets/audio/home-deep-night.mp3", "./assets/audio/home-morning.mp3", "./assets/audio/home-night.mp3", "./manifest.webmanifest", "./icons/icon.svg"];
