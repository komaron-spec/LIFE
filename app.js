...
function updateWorldCoreLive() {
  ...
  globe.style.setProperty("--moon-x", `${celestial.moonX}%`); globe.style.setProperty("--moon-y", `${celestial.moonY}%`); globe.style.setProperty("--moon-shadow", celestial.moonShadow);
}
