...
function liquidArtworkFor(scene, world = state.world || {}, now = new Date()) {
  ...
  if (scene.id === "home-night") return `<div class="liquid-artwork ${profile.tone} ${modifiers} is-rendered-night" id="local-liquid-artwork" aria-hidden="true"><i class="night-liquid-inertia"></i><i class="night-liquid-caustic"></i><i class="night-star-depth far"></i><i class="night-star-depth mid"></i><i class="night-star-depth near"></i><i class="liquid-reflection"></i></div>`;
