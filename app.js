...
function liquidArtworkFor(scene, world = state.world || {}, now = new Date()) {
  ...
  if (scene.id === "home-night") return `<div class="liquid-artwork ${profile.tone} ${modifiers} is-specimen-night" id="local-liquid-artwork" aria-hidden="true"><i class="night-liquid-transmission"></i><i class="night-liquid-inertia"></i><i class="night-liquid-caustic"></i><i class="liquid-reflection"></i></div>`;
...
function renderPage(page, transitionDirection = "forward") {
  ...
  if (page === "sound") content = content.replace('<section class="sound-player', `${renderSoundNowPlaying()}<section class="sound-player`);
